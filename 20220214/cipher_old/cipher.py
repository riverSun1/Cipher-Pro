...
#-----------------------------------------------------------------------------------------
    ...
    def initUI(self):
        ...
        tt = TimeThread() #self는 WindowClass의 인스턴스, Thread 클래스에서 parent로 전달 
        tt.start()
        ...
        #---------------------------------------------------------------------------------
        self.thread_start = SensorThread()
        self.thread_start.ard_signal.connect(self.edit11.setText) # label text signal
...
#            grid1.addWidget(Btn2,1,2)
    ...
    def createSensorGroup(self):
        ...
        grid3.addWidget(self.edit11, 4, 1)
