...
class Ui_MainWindow(object):
    ...
    def retranslate_Ui(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "UART Terminal v1.0"))

        self.label.setText(_translate("MainWindow", "PyQT5..!!!"))
        self.pushButton.setText(_translate("MainWindow", "Button"))
        self.pushButton.clicked.connect(self.label_change_UI)
